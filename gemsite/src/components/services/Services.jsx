  ...
  return (
    <div className='service'>
      ...
      <div className='our-services'>
        ...
        <p>
          We strive to provide exceptional service, integrity, and commitment in
      ...
      <div className='services-content'>
        <div className='service-cards'>
          ...
          <div class='card'>
            ...
            <p>
              We offer reliable international shipping with tracking and
              insurance to ensure your gemstones reach you safely.
            </p>
          </div>
          <div class='card'>
            ...
            <p>
              Each gemstone comes with a certificate from renowned labs,
          ...
          <div class='card'>
            ...
            <p>
              Looking for something unique? Our experts will source the perfect
              gemstone based on your specifications.
            </p>
          </div>
          <div class='card'>
            ...
            <p>
              Join our loyalty program for exclusive discounts, promotions, and
              rewards.
            </p>
          </div>
        </div>
